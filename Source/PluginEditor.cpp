...
LevelMeterAudioProcessorEditor::LevelMeterAudioProcessorEditor (LevelMeterAudioProcessor& p)
    ...
    circularMeterL([&]() { return audioProcessor.getRmsLevel(0); }, Colours::fuchsia),
    circularMeterR([&]() { return audioProcessor.getRmsLevel(1); }, Colours::cyan)
{
    ...
    rightSlider.setColour(Slider::ColourIds::rotarySliderFillColourId, Colours::turquoise.withBrightness(0.6f));
    rightSlider.setColour(Slider::ColourIds::thumbColourId, Colours::turquoise);
...
{
    horizontalMeterL.setLevel(audioProcessor.getRmsLevel(0));
    horizontalMeterR.setLevel(audioProcessor.getRmsLevel(1));
